...
export const getGetAllSneakerImageQueryOptions = <TData = Awaited<ReturnType<typeof getAllSneakerImage>>, TError = unknown>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getAllSneakerImage>>, TError, TData>, request?: SecondParameter<typeof customInstance>}
) => {
...
export const useGetAllSneakerImage = <TData = Awaited<ReturnType<typeof getAllSneakerImage>>, TError = unknown>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getAllSneakerImage>>, TError, TData>, request?: SecondParameter<typeof customInstance>}
...
export const getGetByQuerySneakerImageQueryOptions = <TData = Awaited<ReturnType<typeof getByQuerySneakerImage>>, TError = unknown>(params?: GetByQuerySneakerImageParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getByQuerySneakerImage>>, TError, TData>, request?: SecondParameter<typeof customInstance>}
) => {
...
export const useGetByQuerySneakerImage = <TData = Awaited<ReturnType<typeof getByQuerySneakerImage>>, TError = unknown>(
 params?: GetByQuerySneakerImageParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getByQuerySneakerImage>>, TError, TData>, request?: SecondParameter<typeof customInstance>}
...
export const getGetOneSneakerImageQueryOptions = <TData = Awaited<ReturnType<typeof getOneSneakerImage>>, TError = unknown>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getOneSneakerImage>>, TError, TData>, request?: SecondParameter<typeof customInstance>}
) => {
...
export const useGetOneSneakerImage = <TData = Awaited<ReturnType<typeof getOneSneakerImage>>, TError = unknown>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getOneSneakerImage>>, TError, TData>, request?: SecondParameter<typeof customInstance>}
